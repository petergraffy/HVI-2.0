...
3. Structural vulnerability modeling using community-level demographic, built-environment, health, socioeconomic, and tree canopy covariates.
4. Public dashboard export generation, including historical community-area-day temperature/risk/tree-canopy summaries, condition-specific excess-event summaries, all-cause excess-burden cost summaries, precomputed temperature/NDVI/AC loss-of-cooling scenario grids, and annual 5-, 10-, and 20-year forecast planning exports. Humidity is retained as a model-matrix field for sensitivity analyses but is inactive in the public slider grid by default.
